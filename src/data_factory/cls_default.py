tasks = ['ebrains_subtyping_coarse', 'ebrains_subtyping_fine', 'panda', 'LUAD_TMB', 'LUAD_EGFR', 'STAD_MENTIS', 'STAD_SENSOR', 'CRC_MENTIS', 'CRC_SENSOR']
label_dicts = {
        ...
        'LUAD_TMB': {'TMB_low': 0, 'TMB_high': 1},
        'LUAD_EGFR': {'n': 0, 'y': 1},
        'STAD_MENTIS': {'MSS': 0, 'MSI': 1},
        'STAD_SENSOR': {'MSS': 0, 'MSI': 1},
        'CRC_MENTIS': {'MSS': 0, 'MSI': 1},
        'CRC_SENSOR': {'MSS': 0, 'MSI': 1},
}